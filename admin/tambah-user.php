...
// masukan ke dalam table user (name, email, password) nilainya dari masing-masing inputan
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input required name="name" type="text" class="form-control" placeholder="Masukan Nama Anda" value="<?= $rowEdit['name'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <input required name="email" type="text" class="form-control" placeholder="Masukan Email Anda" value="<?= $rowEdit['email'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <div class="col-sm-2">
